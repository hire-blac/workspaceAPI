...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>WorkspaceAPI Notes</title>
        ...
        <div class="container">
          <h4 class="text-center"><a href="/" class="btn btn-outline-primary">Back Home</a></h4>
            ...
            <p>
              ...
              <ul>
                <li>Name (space_type_name)</li>
              </ul>
            </p>

            <h3>Spaces</h3>
            <p>
              The workspaces available for booking/rent eg.
              <ul>
                <li>Smart office 1</li>
                <li>Work station 1</li>
                <li>Work station 2</li>
                <li>Work station 3 etc.</li>
                <li>Desk 1</li>
                <li>Desk 2</li>
                <li>Desk 3 etc.</li>
              </ul>
